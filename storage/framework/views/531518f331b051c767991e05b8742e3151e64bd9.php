...
} elseif ($_instance->childHasBeenRendered('nAZkAp8')) {
    $componentId = $_instance->getRenderedChildComponentId('nAZkAp8');
    $componentTag = $_instance->getRenderedChildComponentTagName('nAZkAp8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nAZkAp8');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('nAZkAp8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<!--================ codigo body=======================================  -->
...
} elseif ($_instance->childHasBeenRendered('hQqjKIX')) {
    $componentId = $_instance->getRenderedChildComponentId('hQqjKIX');
    $componentTag = $_instance->getRenderedChildComponentTagName('hQqjKIX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hQqjKIX');
} else {
    $response = \Livewire\Livewire::mount('notification-secction', []);
    $html = $response->html();
    $_instance->logRenderedChild('hQqjKIX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
      ...
      <li class=" nav-item"><a href="index.html"><i class="#" data-icon="desktop"></i><span class="menu-title text-truncate" data-i18n="Dashboard">Modulos</span><span class="badge badge-light-danger badge-pill badge-round float-right mr-50 ml-auto">2</span></a>
        <ul class="menu-content">
          ...
          <li><a class="d-flex align-items-center" href="<?php echo e(url('cuentasporpagar')); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Cuentas por Pagar</span></a>
          </li>

          <li><a class="d-flex align-items-center" href="<?php echo e(url('descargasv2')); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Descargas</span></a>
          </li>
          ...
          <li><a class="d-flex align-items-center" href="<?php echo e(('volumetrico')); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Control Volumetrico</span></a>
          </li>
          ...
          <li><a class="d-flex align-items-center" href="<?php echo e(('auditoria')); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Auditoria</span></a>
          </li>
          <li><a class="d-flex align-items-center" href="<?php echo e(('consultas')); ?>"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Analytics">Consultas</span></a>
          </li>
...
<script type="text/javascript">
    ...
    </script><?php /**PATH C:\Conta\Contarapp2.0\resources\views/layouts/app.blade.php ENDPATH**/ ?>