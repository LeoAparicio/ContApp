...
} elseif ($_instance->childHasBeenRendered('l3108556124-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3108556124-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3108556124-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3108556124-0');
} else {
    $response = \Livewire\Livewire::mount('uploadrelacionados', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3108556124-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\sistema\resources\views/livewire/chequesytransferencias.blade.php ENDPATH**/ ?>